...
<div class="category-filter-section mb-5">
    ...
    <div class="category-filter-container mb-4">
        <div class="d-flex flex-wrap gap-2 mb-3">
            ...
            ?>
            <a href="index.php" class="btn btn-lg <?= $all_class; ?> px-4 py-2 rounded-pill">
            ...
            <?php while($cat = $categories_res->fetch_assoc()): ?>
                ...
                ?>
                <a href="customer/products.php?category_id=<?php echo $cat['category_id']; ?>" 
        ...
        <?php if($category_id > 0): ?>
            ...
            <div class="alert alert-info alert-dismissible fade show d-flex align-items-center" role="alert">
                ...
                <a href="index.php" class="btn-close ms-auto" aria-label="Clear filter"></a>
            </div>
        <?php endif; ?>
    </div>
</div>
...
if ($products_res && $products_res->num_rows > 0):
    ...
    // Enhanced image handling with larger display
    $image_url = $prod['image_url'] ?: 'assets/images/placeholder.png'; 
...
<div class="row mt-4">
    <div class="col-12">
        <div class="alert alert-light border d-flex justify-content-between align-items-center">
            ...
            <a href="customer/products.php" class="btn btn-outline-danger btn-sm">
